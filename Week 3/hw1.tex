...
\tightlist
\item
  Zero at approximately \(x = 5\)
\end{enumerate}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{curve}\NormalTok{(}\KeywordTok{sqrt}\NormalTok{(}\DecValTok{3}\OperatorTok{*}\NormalTok{x) }\OperatorTok{{-}}\StringTok{ }\DecValTok{4}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
##  monte_carlo(10) 7.101 7.701 8.43698 7.9015 8.401 46.201   100
\end{verbatim}
...
## Unit: milliseconds
##                expr      min      lq     mean   median       uq     max neval
##  monte_carlo(1e+05) 7.632201 8.45985 9.381431 8.780701 9.500851 16.6905   100
\end{verbatim}
...
## Unit: milliseconds
##                expr     min       lq     mean  median       uq      max neval
##  monte_carlo(1e+06) 79.0217 80.49285 84.24118 84.4154 86.13245 119.4025   100
\end{verbatim}
