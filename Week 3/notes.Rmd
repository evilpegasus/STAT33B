...
setwd("C:/Users/mingf/Desktop/git/STAT33B/Week 3")
```
...
list.files("/Users/mingf/Desktop/git/")
```
...
```{r}
dogs = readRDS("Week 3/data/dogs_sample.rds")
```
...
```{r}
dogs = readRDS("data/dogs_sample.rds")
...
```{r}
volcano = read.delim("data/volerup.txt")
```
...
```{r}
write.csv(volcano, "data/volcano.csv")
```
